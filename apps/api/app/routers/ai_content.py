...
def _ai_content_prefix(publisher_slug: str, book_name: str) -> str:
    """Build the base MinIO prefix for ai-content under a book."""
    return f"{publisher_slug}/books/{book_name}/ai-content/"


def _content_prefix(publisher_slug: str, book_name: str, content_id: str) -> str:
    """Build the MinIO prefix for a specific content_id folder."""
    return f"{publisher_slug}/books/{book_name}/ai-content/{content_id}/"
...
def create_ai_content(
    ...
    prefix = _content_prefix(book.publisher_rel.slug, book.book_name, content_id)
...
def list_ai_content(
    ...
    client = get_minio_client(settings)
    bucket = settings.minio_publishers_bucket
    base_prefix = _ai_content_prefix(book.publisher_rel.slug, book.book_name)
